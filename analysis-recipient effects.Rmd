...
# t-test
risk_excluded %>% 
  t_test(risklevel ~ condition, comparisons = list(c("1", "2"), c("1", "3")), paired = FALSE) 
...
# t-test
risk_excluded %>% 
  t_test(neg ~ condition, comparisons = list(c("1", "2"), c("1", "3")), paired = FALSE) 
...
# t-test
risk_excluded %>% 
  t_test(pos ~ condition, comparisons = list(c("1", "2"), c("1", "3")), paired = FALSE) 
...
# t-test
risk_excluded %>% 
  t_test(alert ~ condition, comparisons = list(c("1", "2"), c("1", "3")), paired = FALSE) 
