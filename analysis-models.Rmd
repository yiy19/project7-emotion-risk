...
risk_sur <- risk_sur %>% 
  mutate(
        ...
        # recode condition variable
         conditionrecoded = case_when(condition == 1 ~ -1,
                         condition == 2 ~ 1),
...
```{r self-sur-moderation, eval = FALSE}
